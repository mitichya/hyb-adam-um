...
- Fastest mean runtime: **fd_step_small** (36.1211 s).

## Relative changes versus baseline
- **old_global_mean_init**: RMSE_miss +58.51%, Delta_final +19.47%, runtime -1.08% relative to baseline.
- **two_restarts**: RMSE_miss +0.06%, Delta_final -0.51%, runtime +96.16% relative to baseline.
- **lr_init_low**: RMSE_miss +34.32%, Delta_final +7.12%, runtime -2.38% relative to baseline.
- **lr_init_high**: RMSE_miss +30.97%, Delta_final +41.60%, runtime -2.77% relative to baseline.
- **schedule_fast_decay**: RMSE_miss +0.10%, Delta_final -0.37%, runtime -4.04% relative to baseline.
- **schedule_slow_decay**: RMSE_miss -0.05%, Delta_final +10.26%, runtime -3.71% relative to baseline.
- **clip_low**: RMSE_miss -0.35%, Delta_final +1.01%, runtime -2.86% relative to baseline.
- **clip_high**: RMSE_miss +23.82%, Delta_final +7.46%, runtime -3.17% relative to baseline.
- **clip_none**: RMSE_miss +129.09%, Delta_final +796.64%, runtime -4.21% relative to baseline.
- **fd_step_small**: RMSE_miss -0.16%, Delta_final +0.47%, runtime -4.55% relative to baseline.
- **fd_step_large**: RMSE_miss -0.40%, Delta_final -3.38%, runtime -3.41% relative to baseline.
